...
void CServerInfo::ReadConfig() // OK
{
	...
	LogAdd(LOG_BLUE,"[AntiHackServerInfo] Config loaded successfully");
}
...
void CServerInfo::ReadDumpList() // OK
{
	...
	LogAdd(LOG_BLUE,"[AntiHackServerInfo] DumpList loaded successfully");
}
...
void CServerInfo::ReadChecksumList() // OK
{
	...
	LogAdd(LOG_BLUE,"[AntiHackServerInfo] ChecksumList loaded successfully");
}
...
void CServerInfo::ReadInternalList() // OK
{
	...
	LogAdd(LOG_BLUE,"[AntiHackServerInfo] InternalList loaded successfully");
}
...
void CServerInfo::ReadWindowList() // OK
{
	...
	LogAdd(LOG_BLUE,"[AntiHackServerInfo] WindowList loaded successfully");
}
...
void CServerInfo::ReadBlackList() //OK
{
	...
	LogAdd(LOG_BLUE,"[AntiHackServerInfo] BlackList loaded successfully");
}
