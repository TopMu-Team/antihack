...
//	char TempInfo[100];
	...
	info.IpAddressPort = GetPrivateProfileInt("ClientInfo","IpAddressPort",0,".\\ClientInfo.ini");
	GetPrivateProfileString("ClientInfo","ClientVersion","",info.ClientVersion,sizeof(info.ClientVersion),".\\ClientInfo.ini");
	GetPrivateProfileString("ClientInfo","ClientSerial","",info.ClientSerial,sizeof(info.ClientSerial),".\\ClientInfo.ini");
	...
	HANDLE file = CreateFile("Main.Info",GENERIC_WRITE,FILE_SHARE_READ,0,CREATE_ALWAYS,FILE_ATTRIBUTE_ARCHIVE,0);
